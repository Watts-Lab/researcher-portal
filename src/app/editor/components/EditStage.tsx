...
import { TreatmentType, stageSchema, StageType} from "@/../deliberation-empirica/server/src/preFlight/validateTreatmentFile";
...
export function EditStage({
  ...
  const { register, watch, handleSubmit, setValue, formState: {isValid, errors} } = useForm<StageType>(
